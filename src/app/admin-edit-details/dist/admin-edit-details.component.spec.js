...
var admin_edit_details_component_1 = require("./admin-edit-details.component");
describe('AdminEditDetailsComponent', function () {
    var component;
    var fixture;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [admin_edit_details_component_1.AdminEditDetailsComponent,
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(admin_edit_details_component_1.AdminEditDetailsComponent);
