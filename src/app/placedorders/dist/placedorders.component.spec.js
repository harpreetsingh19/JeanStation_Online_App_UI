...
var placedorders_component_1 = require("./placedorders.component");
describe('PlacedordersComponent', function () {
    var component;
    var fixture;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [placedorders_component_1.PlacedordersComponent,
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(placedorders_component_1.PlacedordersComponent);
