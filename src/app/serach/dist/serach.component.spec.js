...
var serach_component_1 = require("./serach.component");
describe('SerachComponent', function () {
    var component;
    var fixture;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [serach_component_1.SerachComponent,
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(serach_component_1.SerachComponent);
