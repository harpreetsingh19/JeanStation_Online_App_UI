...
describe('AddproductComponent', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [addproduct_component_1.AddproductComponent,
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(addproduct_component_1.AddproductComponent);
    ...
    it('should render welcome message', function () {
        var fixture = testing_1.TestBed.createComponent(addproduct_component_1.AddproductComponent);
        fixture.detectChanges();
