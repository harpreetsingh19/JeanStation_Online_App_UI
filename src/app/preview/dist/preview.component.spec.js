...
describe('PreviewComponent', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [preview_component_1.PreviewComponent,
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(preview_component_1.PreviewComponent);
    ...
    it('should render welcome message', function () {
        var fixture = testing_1.TestBed.createComponent(preview_component_1.PreviewComponent);
        fixture.detectChanges();
