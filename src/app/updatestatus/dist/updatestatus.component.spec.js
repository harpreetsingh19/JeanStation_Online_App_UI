...
var updatestatus_component_1 = require("./updatestatus.component");
describe('UpdatestatusComponent', function () {
    var component;
    var fixture;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [updatestatus_component_1.UpdatestatusComponent,
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(updatestatus_component_1.UpdatestatusComponent);
